        ...
        <div className="flex items-center gap-4">
          ...
          <div>
            ...
            <div className="flex items-center gap-2">
              ...
              <p className="text-sm text-muted-foreground">{workspace.documentCount} Documents</p>
            </div>
          </div>
        </div>
        {isSuperAdmin && (
          <div className="flex items-center gap-2">
            <EditWorkspaceDialog workspace={workspace}>
              <Button variant="outline" size="icon" className="hover:text-green-500">
  ...
  return (
    <Card className="border shadow hover:shadow-lg transition-all">
      <CardHeader className="p-0">
        <img
          src={workspace.coverImage || "/placeholder.svg?height=144&width=384"}
          alt={workspace.name}
        ...
        <div className="flex justify-between items-start">
          <div>
            ...
            <p className="text-sm text-muted-foreground flex items-center gap-2 mt-1">
              <FileText className="h-4 w-4" /> {workspace.documentCount} Documents
            </p>
          </div>
          {isSuperAdmin && (
